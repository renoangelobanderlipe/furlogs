    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'attributes' => [
                ...
                'avatarUrl' => $pet->relationLoaded('media') ? ($pet->getFirstMediaUrl('avatar', 'card') ?: null) : null,
                'thumbUrl' => $pet->relationLoaded('media') ? ($pet->getFirstMediaUrl('avatar', 'thumb') ?: null) : null,
